...
val get_env_stack : state -> Memory.env_stack
val get_memory : state -> Memory.memory
val loc_of_envval : Memory.envval -> Memory.loc
val fun_of_envval_instr : Memory.envval -> Ast.instruction
val fun_of_envval_params : Memory.envval -> Ast.parameters
val intrinsic_of_ide : Memory.ide -> Ast.intrinsic
val expression_list_of_trace_expr :
  state * Ast.expression list -> Ast.expression list
